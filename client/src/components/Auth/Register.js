...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    console.log('🔍 REGISTER FORM: Form submitted with:', { 
    ...
    try {
      ...
      console.log('🔍 REGISTER FORM: Registration result:', result);
      setIsLoading(false);
      
      if (result.success) {
        console.log('✅ REGISTER FORM: Registration successful, navigating to dashboard');
        navigate('/dashboard');
      } else {
        console.log('❌ REGISTER FORM: Registration failed:', result.error);
      }
    } catch (error) {
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className={`input ${errors.firstName ? 'border-danger-300 focus:border-danger-500 focus:ring-danger-500' : ''}`}
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className={`input ${errors.lastName ? 'border-danger-300 focus:border-danger-500 focus:ring-danger-500' : ''}`}
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    autoComplete="new-password"
                    className={`input pr-10 ${errors.confirmPassword ? 'border-danger-300 focus:border-danger-500 focus:ring-danger-500' : ''}`}
              ...
              <div>
                ...
                <div className="mt-1">
                  <select
                    id="role"
                    className={`input ${errors.role ? 'border-danger-300 focus:border-danger-500 focus:ring-danger-500' : ''}`}
                    {...register('role', {
